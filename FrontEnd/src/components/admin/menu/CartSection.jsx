...
const CartSection = ({ cart, onRemoveFromCart, onUpdateQuantity, onClearCart, totalAmount, totalItems, onProcessPayment, tableNumber, onTableNumberChange, paymentMethod, onPaymentMethodChange }) => {
    ...
    <div className="bg-white rounded-lg shadow-lg p-4 sticky top-4">
      ...
      {isCartOpen && (
        <>
          ...
          <div className="mb-3">
            <label className="block text-xs font-semibold text-gray-700 mb-1.5">
              <i className="fas fa-credit-card mr-1 text-xs"></i>Payment Method <span className="text-red-500">*</span>
            </label>
            <select
              value={paymentMethod}
